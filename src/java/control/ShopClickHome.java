 ...
 * @author nguye
 */
@WebServlet(name = "ShopClickHome", urlPatterns = {"/clickhome"})
public class ShopClickHome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("ShopGridHome.jsp").forward(request, response);
