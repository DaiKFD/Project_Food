<%-- 
    Document   : ManageFood
    Created on : Dec 14, 2021, 9:09:28 PM
    Author     : nguye
--%>
                        ...
                        <tbody>
                            <c:forEach items="${listF}" var="f">
                                <tr>
                                    ...
                                    <td>${f.foodName}</td>
                                    <td>
                                        <img src="${f.foodImage}" style="width: 25%; height: 25%"></img>
                                    </td>
                                    <td>${f.foodPrice}</td>
                                    <td>${f.foodDesctiption}</td>
                                    <td>${f.foodAvailability}</td>
                                    <td>${f.foodWeight} Kg</td>
                                    <td>
                                        <a href="edit?fid=${f.foodId}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="delete?fid=${f.foodId}" class="delete" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                    ...
                    <form action="add" method="POST">
                        ...
                        <div class="modal-body">					
                            <div class="form-group">
                                ...
                                <input name="fid" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="descrip" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Sản Phẩm Sẵn Có</label>
